...
-   or pass a local SEC DERA zip:   python 13f_summary.py --zip /path/to/form13f.zip
-   sample fixture for dev/testing: python 13f_summary.py --zip fixtures/sample_13f.zip
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  # local SEC DERA quarterly zip\n"
            "  python 13f_summary.py --zip /Downloads/01dec2025-28feb2026_form13f.zip\n\n"
            "  # sample fixture for development / CI\n"
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Path to a local SEC DERA 13F dataset zip file "
            "(overrides LOCAL_ZIP_PATH in the config section). "
            "Download from https://www.sec.gov/dera/data/form-13f-data-sets"
        ),
    )
    args = parser.parse_args()

    # CLI flag takes precedence over the in-file config constant

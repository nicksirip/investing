...
| [global-recession-positioning-guide.md](scenarios/global-recession-positioning-guide.md) | Portfolio positioning through a synchronized global recession — from coordinated slowdown signals through multi-economy contraction, EM sovereign stress, and eventual global recovery |
...
| [post-ww2-financial-reset-positioning-guide.md](scenarios/post-ww2-financial-reset-positioning-guide.md) | Portfolio positioning for a post-war-style financial reset of policy-managed growth, moderate inflation, and long-cycle rebuilding |
...
| [moving_average_direction_study.thinkscript](think-or-swim/moving_average_direction_study.thinkscript) | Configurable moving-average study with selectable MA type/length/price basis, direction-based MA coloring (up/down/flat), and an optional hidden crossover direction indicator (+1/-1/0) |
...
| [supertrend_study.thinkscript](think-or-swim/supertrend_study.thinkscript) | ATR-based Supertrend study that draws a trailing support/resistance line (green = uptrend, red = downtrend) and plots buy/sell signal arrows on trend flips; configurable ATR length, multiplier, arrow offset, and optional bar coloring |
